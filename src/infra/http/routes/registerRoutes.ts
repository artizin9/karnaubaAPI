...
import { createNewsRoutes, deleteNewsRoutes, getAllNewsRoutes, getByIdNewsRoutes, updateNewsRoutes, updatePhotoNewsRoutes } from "./newsRoutes";
import { createVideo, deleteAllVideo, deleteVideo, getAllVideo, getIdVideo, updateVideo} from "./videoRoutes";

const routes = [adminRegister, adminLogin, adminDelete, adminUpdate, adminFindUnique, adminLogOut, adminCreateGoogle, adminLoginGoogle, cityDelete, cityFindMany, cityRegister, cityFindUnique, cityUpdate, cityUpdatePhoto, cityCreatePhoto, cityDeletePhoto, placeByCategory, placeDelete, placeFindAll, placeRegister, placeUpdate, placeFindUnique, placeUpdatePhoto, placeCreatePhoto, placeDeletePhoto, eventRegister, updateEvent, deleteEvent, findAllEvent, findUniqueEvent, UpdatePhotoEvent, CreatePhotoEvent, DeletePhotoEvent, findAvailableEvent, createRoom, findUniqueRoom, findAllRooms, updateRoom, deleteRoom, findAvailableRooms, createTaxiDriver, updateTaxiDriver, deleteTaxiDriver, findAllTaxiDrivers, findUniqueTaxiDriver, relatedPlacesById, createNewsRoutes, updateNewsRoutes, getAllNewsRoutes, getByIdNewsRoutes, deleteNewsRoutes, updatePhotoNewsRoutes, createVideo, updateVideo, deleteVideo, getAllVideo, getIdVideo, deleteAllVideo];
